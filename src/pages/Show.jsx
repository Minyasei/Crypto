            ...
            <div className="width">
              ...
              <div className="show-details-row">
                ...
                <span>
                  ...
                  <br />
                  {store.data.market_data.high_24h.try} TL
                </span>
              </div>
              <div className="show-details-row">
                <h3>24h Lowest</h3>
                <span>
                  ...
                  <br />
                  {store.data.market_data.low_24h.try} TL
                </span>
              </div>
              <div className="show-details-row">
              ...
              <div className="show-details-row">
                <h3>Current Price</h3>
                <span>
                  $ {store.data.market_data.current_price.usd} <br />
                  {store.data.market_data.current_price.try} TL
                </span>
              </div>
              <div className="show-details-row">
                <h3>1 Year Change</h3>
